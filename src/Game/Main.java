...
do {
    ...
    System.out.print("\n                      WELCOME TO DRIVER GAME! \n\n" +
            "Imagine your are in your car driving in the city faster that is allowed. \n" +
            "You are going to work. It's morning, and your are 15 minutes late.\n" +
    ...
    if (answer.equals("Y")) { // 1-st answer
        ...
        if (answer.equals("L")) { // 2-nd answer
            ...
            System.out.print("\nYou turned in your left. \n" +
                    ...
                    "Imagine that you have another chance to change one of your choices. Which one would you changed: 1 , 2 , 3 or 4? \n");
            answer = input.nextLine();
            answer = answer.toUpperCase();
        ...
        if (answer.equals("Y")) {// 2-nd answer
            ...
            System.out.print("\nThe car in front of you stop suddenly. You don't have enough time to stop and you hit it so hard.\n" +
                    ...
                    "Imagine that you have another chance to change one of your choices. Which one would you changed: 1 , 2 or 3?\n");
            answer = input.nextLine();
            answer = answer.toUpperCase();
